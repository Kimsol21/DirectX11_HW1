...
bool SystemClass::Frame()
{
	...
	if(m_Input->IsKeyDown(VK_ESCAPE)) //ESCÅ°¸¦ ´­·¶À»¶§
	{
		return false; //½Ã½ºÅÛ Á¾·á
	}

	if (m_Input->IsKeyDown(0x52)) //RÅ°¸¦ ´­·¶À» ¶§
	{
		m_Graphics->ChangeBGColor(1.0f, 0.0f, 0.0f, 1.0f);
	}

	if (m_Input->IsKeyDown(0x47)) //GÅ°¸¦ ´­·¶À» ¶§
	{
		m_Graphics->ChangeBGColor(0.0f, 1.0f, 0.0f, 1.0f);
	}

	if (m_Input->IsKeyDown(0x42)) //BÅ°¸¦ ´­·¶À» ¶§
	{
		m_Graphics->ChangeBGColor(0.0f, 0.0f, 1.0f, 1.0f);
	}

	if (m_Input->IsKeyDown(0x31)) //1Å°¸¦ ´­·¶À» ¶§
	{
		m_Graphics->ChangeBrightness(1.0f);
	}

	if (m_Input->IsKeyDown(0x32)) //2Å°¸¦ ´­·¶À» ¶§
	{
		m_Graphics->ChangeBrightness(0.5f);
	}

	if (m_Input->IsKeyDown(0x57)) //WÅ°¸¦ ´­·¶À» ¶§
	{
		m_Graphics->ChangeFillMode(D3D11_FILL_WIREFRAME);
	}

	if (m_Input->IsKeyDown(0x53)) //SÅ°¸¦ ´­·¶À» ¶§
	{
